...
This file contains the list of dependencies that this function needs to run. Cloud Functions automatically install the dependencies.
...
Write code to modify a Cloud Function
    ...
    Add a new property called score to the feedback object. *Complete the arrow function body by returning the feedback object.
...
Run the web application
    ...
    Change the working folder back to the start folder for the cloudfunctions lab. cd ..

    To start the web application, execute the following command: npm start
